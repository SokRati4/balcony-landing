...
const Hero = () => {
  ...
  return (
    <section id="hero-section" className="relative bg-brandSecondary py-16 md:py-24 overflow-hidden">
      <div className="container-custom grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          {/* Floating elements */}
          <div className="absolute -top-4 -right-4 w-20 h-20 bg-brandPrimary-900 rounded-full opacity-20"></div>
          <div className="absolute -bottom-4 -left-4 w-16 h-16 bg-brandPrimary-300 rounded-full opacity-30"></div>
        </motion.div>
      </div>
    </section>
  )
